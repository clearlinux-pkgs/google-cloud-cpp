...
Version  : 2.37.0
Release  : 12
URL      : https://github.com/googleapis/google-cloud-cpp/archive/v2.37.0/google-cloud-cpp-2.37.0.tar.gz
Source0  : https://github.com/googleapis/google-cloud-cpp/archive/v2.37.0/google-cloud-cpp-2.37.0.tar.gz
...
%prep
%setup -q -n google-cloud-cpp-2.37.0
cd %{_builddir}
tar xf %{_sourcedir}/6a474b31c53cc1797710206824a17b364a835d2d.tar.gz
cd %{_builddir}/google-cloud-cpp-2.37.0
mkdir -p external/googleapis
cp -r %{_builddir}/googleapis-6a474b31c53cc1797710206824a17b364a835d2d/. %{_builddir}/google-cloud-cpp-2.37.0/external/googleapis
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746564602
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libgoogle_cloud_cpp_common.so.2.37.0
/usr/lib64/libgoogle_cloud_cpp_rest_internal.so.2
/usr/lib64/libgoogle_cloud_cpp_rest_internal.so.2.37.0
/usr/lib64/libgoogle_cloud_cpp_storage.so.2
/usr/lib64/libgoogle_cloud_cpp_storage.so.2.37.0
